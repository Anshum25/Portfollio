  ...
  const skillCategories = [
    {
      ...
      skills: ["Python", "Java", "JavaScript", "TypeScript", "HTML/CSS", "SQL", "C/C++"]
    },
    {
      title: "Frameworks & Libraries",
      skills: ["React", "Node.js", "Express", "TailwindCSS", "Bootstrap", "Pandas", "NumPy", "TensorFlow","Flask", "Django","OpenCV", "Scikit-learn", "Matplotlib", "Seaborn", "Streamlit","sklearn"]
    },
    {
      title: "Tools & Technologies",
      skills: ["Git", "GitHub", "VS Code","IntelliJ IDEA", "Figma", "MongoDB", "MySQL", "PostgreSQL", "Kubernetes","Vercel", "Firebase", "Jupyter Notebook", "Anaconda",]
    },
    {
      title: "Other Skills",
      skills: ["Problem Solving", "Data Structures", "Algorithms", "UI/UX", "Responsive Design", "REST APIs"]
    }
  ];
