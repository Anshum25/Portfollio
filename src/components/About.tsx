      ...
      <div className="grid md:grid-cols-5 gap-12 px-4 md:px-6">
        <div className="md:col-span-3">
          <div className="space-y-4 text-slate animated-slide-up" ref={textRef as React.RefObject<HTMLDivElement>}>
            <p>
              Hello! I'm Anshum, a passionate B.Tech student specializing in 
              Computer Science at <span className="text-highlight">L.J. INSTITUTE OF ENGINEERING & TECHNOLOGY</span>.
              My journey into coding began during my high school days when I first discovered 
              the excitement of creating my own programs using Java
            </p>
            <p>
              Since then, I've expanded my skills to include web technologies and machine learning.
            ...
            <p>
              Outside of programming, I enjoy playing chess, reading sci-fi novels, writing and hiking.
              I'm always looking for new opportunities to learn and grow in the tech field.
            </p>
          </div>
        ...
        <div className="md:col-span-2">
          <div className="relative group max-w-xs mx-auto md:mx-0 animated-rotate" ref={imageRef as React.RefObject<HTMLDivElement>}>
            <div className="relative rounded-md overflow-hidden z-10">
              <img 
                src="/public/WhatsApp Image 2025-02-14 at 22.46.28.jpeg"
                alt="Anshum Dev" 
